...
class TCL_Metabox {
    ...
    // ★ キーワードテキストの安全な取得 ★
    const keywordText = keyword.text || keyword.keyword || keyword || 'キーワード' + (index + 1);
    ...
    html += '<input type="checkbox" class="keyword-checkbox" value="' + keywordText + '" id="' + keywordId + '" style="margin-right: 8px;">';
    html += '<label for="' + keywordId + '" style="flex: 1; font-size: 12px; cursor: pointer;">' + keywordText + '</label>';
